...
if ( isset($_GET["tag"]) ) {
	...
	$url = "http://api.flickr.com/services/rest/?method=flickr.photos.search&sort=relavancy&api_key=".$apiKey."&tags=".$_GET["tag"]."&per_page=20&extras=url_m,url_sq,url_o,tags";
